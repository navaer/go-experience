    ...
    <section class="demo-hero confirmation" aria-labelledby="demo-hero-title">
        <div class="demo-container demo-hero_wrap">
            ...
            <div class="demo-hero_text">
                <div data-aos="fade-up" class="demo-eyebrow">{{ __('Thank you for applying with GoFinancial') }}</div>
                <h1 data-aos="fade-up" id="demo-hero-title" class="demo-title">
                    {{ __('Your loan application') }}<br>{{ __('has been submitted') }}</h1>
                <p data-aos="fade-up" class="demo-sub">
                    {{ __('We’ve received your loan request and our team is reviewing your information. You’ll receive an update soon with the next steps and your application summary below.') }}
                </p>
        ...
        <div class="demo-container">
            <div class="demo-confirm_cards" data-aos="fade-up">
                ...
                <article class="demo-card" aria-labelledby="appt-summary-title">
                    <h2 class="demo-title" id="appt-summary-title" style="margin-top:0">{{ __('Application Summary') }}</h2>
                    ...
                    <div class="demo-kv">
                        <div class="demo-ico" aria-hidden="true">
                            <svg viewBox="0 0 24 24" fill="none">
                                <path d="M4 6h16v12H4zM4 7l8 6 8-6" stroke="currentColor" stroke-width="2"
                    ...
                    <div class="demo-kv">
                        ...
                        <div class="demo-kv_text">
                            <small>{{ __('ID Number') }}</small>
                            <strong>{{ $debtCollection->id_number }}</strong>
                        </div>
                    </div>
                ...
                <article class="demo-card" aria-labelledby="appt-details-title">
                    ...
                    <div class="demo-kv">
                        ...
                        <div class="demo-kv_text">
                            <small>{{ __('Loan Type') }}</small>
                            <strong>{{ Str::ucfirst(__($debtCollection->loan_type)) }}</strong>
                        </div>
                    </div>
                    ...
                    <div class="demo-kv">
                        ...
                        <div class="demo-kv_text">
                            <small>{{ __('Product') }}/{{ __('Description') }}</small>
                    ...
                    <div class="demo-kv">
                        ...
                        <div class="demo-kv_text">
                            <small>{{ __('Requested Amount') }}</small>
                            <strong>$ {{ number_format($debtCollection->amount, 2) }}</strong>
                        </div>
                    </div>
                    ...
                    <div class="demo-kv">
                        ...
                        <div class="demo-kv_text">
                            <small>{{ __('Employment Status') }}</small>
                    ...
                    <div class="demo-kv">
                        ...
                        <div class="demo-kv_text">
                            <small>{{ __('Preferred Contact Method') }}</small>
                            <strong>{{ Str::ucfirst(__($debtCollection->preferred_contact_type)) }}</strong>
                        </div>
                    </div>
