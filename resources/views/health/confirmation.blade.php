  ...
  <div class="demo-container">
    <div class="demo-confirm_cards" data-aos="fade-up">
      ...
      <article class="demo-card" aria-labelledby="appt-summary-title">
        ...
        <div class="demo-kv">
          <div class="demo-ico" aria-hidden="true">
            <svg viewBox="0 0 24 24" fill="none"><path d="M7 3v4M17 3v4M4 11h16M5 7h14a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2Z" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>
          </div>
          <div class="demo-kv_text">
            <small>Date & time</small>
            <strong>Tue, Oct 14, 2025 — 10:30 AM</strong>
          </div>
        </div>
        ...
        <div class="demo-kv">
          ...
          <div class="demo-kv_text">
            ...
            <strong>Main Clinic, 123 Health Ave, Springfield</strong>
          </div>
        </div>
      </article>
      ...
      <article class="demo-card" aria-labelledby="appt-details-title">
        ...
        <div class="demo-kv">
          <div class="demo-ico" aria-hidden="true">
            <svg viewBox="0 0 24 24" fill="none"><path d="M9 7h6M9 11h6M9 15h4M5 3h14v18H5z" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>
          </div>
          <div class="demo-kv_text">
            <small>Notes</small>
            <strong>Annual checkup; prefer morning.</strong>
          </div>
        </div>
