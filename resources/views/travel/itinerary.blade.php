    ...
    <main>
        ...
        <section id="form">
            <div class="form-container">
                <div class="itinerary-menu-btns">
                    ...
                    <button class="itinerary-btn">Flights</button>
                ...
                <div class="add-options">
                    ...
                    <div class="option">
                        <div class="passenger-count">
                            ...
                            <button type="button" class="passenger-btn" id="decreasePassenger">-</button>
                            <input type="number" id="passengerNumber" name="passengerNumber" value="1" min="1"
                                max="10" readonly>
                            <button type="button" class="passenger-btn" id="increasePassenger">+</button>
                        </div>
                    </div>
                </div>
                <form action="#" method="post">
                    <div class="it-field">
                        ...
                        <input type="text" id="from" name="from" value="Philadelphia" required>
                    </div>
                    <div class="it-field">
                        <label for="to">To:</label>
                        <input type="text" id="to" name="to" value="Athens Intl. Airport" required>
                    </div>
                    <div class="it-field">
        ...
        <section id="itinerary-cards">
            <div class="it-card">
                ...
                <div class="it-card-grid">
                    <div class="info-box">
                        ...
                        <small>Travel time: 3 hr 38 min • 2 hr 25 min layover • Philadelphia (PHL)</small>
            ...
            <div class="it-card">
                <div class="it-card-grid">
                    <div class="info-box">
                        <h4>6:35 PM • Philadelphia (PHL)</h4>
            ...
            <div class="it-card orng">
                <div class="it-card-grid">
                    <div class="info-box">
                        ...
                        <small>Travel time: 11 hr 20 min • 2 hr 20 min layover • Philadelphia (PHL)  </small>
            ...
            <div class="it-card orng">
                <div class="it-card-grid">
                    <div class="info-box">
                        <h4>7:40 PM • Philadelphia (PHL)</h4>
